...
$wgResourceModules['skins.bootstrapskin'] = array(
        'styles' => array(
				...
				'bootstrap/bootstrap/css/jquery-ui.min.css' => array( 'media' => 'screen' ),
				'bootstrap/bootstrap/css/glyphicons.css' => array( 'media' => 'screen' ),				//'bootstrap/bootstrap/css/fam-icons.css' => array( 'media' => 'screen' ),
	...
	'scripts' => array(
		...
		'bootstrap/bootstrap/js/html2canvas.js',
		'bootstrap/bootstrap/js/FileSaver.min.js',
		'bootstrap/bootstrap/js/jquery-2.1.1.min.js',
		'bootstrap/bootstrap/js/fabric.min.js',
		'bootstrap/bootstrap/js/png.js',
		'bootstrap/bootstrap/js/zlib.js',
		'bootstrap/bootstrap/js/jspdf.js',
		'bootstrap/bootstrap/js/jspdf.plugin.addimage.js',
		'bootstrap/bootstrap/js/jspdf.plugin.from_html.js',
		'bootstrap/bootstrap/js/jspdf.plugin.javascript.js',
		'bootstrap/bootstrap/js/jspdf.plugin.png_support.js',
		'bootstrap/bootstrap/js/jspdf.plugin.split_text_to_size.js',
		'bootstrap/bootstrap/js/jspdf.plugin.standard_fonts_metrics.js',
	),	
